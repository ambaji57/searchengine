...
public class QueryParser implements QueryParserConstants {
   ...
   */
  public Query parse(String query) throws ParseException,IOException {
	System.out.println("in QueryParser.java in queryparser"+query);
    ReInit(new FastCharStream(new StringReader(query)));
    try {
      // TopLevelQuery is a Query followed by the end-of-input (EOF)
      Query res = TopLevelQuery(field);
	System.out.println("value in res"+res);
        ...
        if (positionCount == 1) {
          ...
          for (int i = 0; i < numTokens; i++) {
            ...
            try {
              boolean hasNext = buffer.incrementToken();
              assert hasNext == true;
              System.out.println("am executing here please find me for phrase query");
              term = termAtt.term();
            } catch (IOException e) {
              // safe to ignore, because we know the number of tokens
            }
